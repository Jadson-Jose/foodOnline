...
class UserProfile(models.Model):
    ...
    profile_picture = models.ImageField(
        ("imagem perfil"), upload_to="users/profile_pictures", blank=True, null=True
    )
    cover_photo = models.ImageField(
        ("foto perfil"), upload_to="users/cover_photos", blank=True, null=True
    )
    address_line_1 = models.CharField(
        ("endereço"), max_length=50, blank=True, null=True
    )
